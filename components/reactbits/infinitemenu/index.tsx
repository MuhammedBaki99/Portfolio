  ...
  return (
    <div className="relative w-full h-full min-h-[100dvh] flex flex-col items-center justify-center">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full min-h-[400px] max-h-[100dvh] max-w-full absolute inset-0 outline-none active:cursor-grabbing"
          ...
          <div className="flex justify-center items-start w-full mt-8 sm:mt-12 md:mt-16 pointer-events-none">
            <h2
              ...
              style={{
                ...
                transitionDuration: isMoving ? '100ms' : '500ms',
              }}
            >
              {activeItem.title}
            </h2>
            ...
            <div className="relative w-full flex justify-center">
              ...
              <p
                className={`
                  ...
                  ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
                  ${isMoving
                    ? 'opacity-0 translate-y-4 pointer-events-none duration-100'
                    : 'opacity-100 translate-y-0 pointer-events-auto duration-500'
                  }
                  px-4 py-2
                `}
                style={{
          ...
          <div className="flex justify-center items-end w-full mb-8 sm:mb-12 md:mb-16 pointer-events-none">
            <button
              ...
              className={`
                ...
                bg-[#00ffff]
                border-[4px] sm:border-[5px] border-black
                rounded-full
                cursor-pointer
                transition-all
                duration-500
                ...
                shadow-lg
                ${isMoving
                  ? 'opacity-0 scale-0 translate-y-8 duration-100'
